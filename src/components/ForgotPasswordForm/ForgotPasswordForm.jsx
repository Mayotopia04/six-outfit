  ...
  return (
    <>
      <div className={s.block}>
        {!emailStatus && <p className={s.text}>The activation key will be sent to your email</p>}
        ...
        {emailStatus && <p className={s.status}>The activation key is sent to your email</p>}
      </div>
      {emailStatus && (
        <div className={s.block}>
